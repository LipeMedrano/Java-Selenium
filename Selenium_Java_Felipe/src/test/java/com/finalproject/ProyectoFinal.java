...
public class ProyectoFinal {
	...
	public void beforeTest() {
		...
		password = base.getJSONValue("tc001", "Password");
		newUserName = base.getJSONValue("tc001", "NewUserName");
	...
	public void tc001() {
		...
		//Step 3	Click login
		orangePage.enterUsernameAndPassword(userName,password);
		...
		orangePage.createNewUserForEmployee(newUserName,"John");
		//Step 10	Insert user recently created into Username textbox
		//Step 11	Click search
		orangePage.searchForUser(newUserName);
		//Step 12	Validate user exist in the table result after click search
		Assert.assertTrue(orangePage.verifyExistingUser(newUserName));
		...
		Assert.assertTrue(orangePage.verifyDeletedUser(newUserName));
